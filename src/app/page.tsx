...
const activities = [
  ...
  { name: "Hidroginastica",          color: "#14b8a6" },
  { name: "Natacao",                 color: "#6366f1" },
  { name: "Karate",                  color: "#e11d48" },
  { name: "Xadrez",                  color: "#7c3aed" },
  { name: "Informatica",             color: "#0891b2" },
  { name: "Bombeiro Mirim",          color: "#b91c1c" },
  { name: "Psicanalise",             color: "#0d9488" },
  { name: "Fisioterapia",            color: "#2563eb" },
  { name: "Funcional",               color: "#15803d" },
  { name: "Danca",                   color: "#c026d3" },
    ...
    <div className="t-shell">
      ...
      <nav className="t-nav">
        <div className="t-nav-inner">
          <span className="t-nav-brand">Associacao Amigo do Povo</span>
          <div className="t-nav-links">
            <a href="#sobre">Sobre</a>
            <a href="#inauguracao">Inauguracao</a>
      ...
      <section className="t-hero">
        <div className="t-hero-inner">
          <div className="t-hero-text">
            <span className="t-badge">Portfolio Social 2023-2026</span>
            <h1 className="t-hero-h1">
              Fazer o bem<br /><em>transforma tudo.</em>
            </h1>
            <p className="t-hero-sub">
              A cada dia, a Associacao Amigo do Povo fortalece seu papel social
              ampliando seu alcance e impactando positivamente inumeras pessoas.
            </p>
          ...
          <div className="t-hero-visual">
            <Image
              src={logoHeader2}
              alt="Logo da Associacao Amigo do Povo"
              className="t-hero-logo"
              priority
            />
          </div>
          <div className="t-metrics">
            <div className="t-metric-card"><strong>3+</strong><span>anos de atuacao</span></div>
        ...
        <div className="t-section-inner">
          <div className="t-sobre-grid">
            <div className="t-sobre-text">
              ...
              <h2 className="t-h2">Nossa historia e missao</h2>
            ...
            <div className="t-card t-sobre-reel-card">
              <div className="t-sobre-reel-clip">
                <iframe
                  ...
                  allowFullScreen
                  title="Reel Associacao Amigo do Povo"
                  scrolling="no"
                />
              </div>
            </div>
      ...
      <section id="inauguracao" className="t-section">
        <div className="t-section-inner">
          <div className="t-section-head">
            <p className="t-label">Marco historico</p>
            <h2 className="t-h2">Inauguracao da Associacao</h2>
      ...
      <section className="t-section t-section-blue" id="atividades">
        <div className="t-section-inner">
          <div className="t-section-head">
            <p className="t-label t-label-white">Esporte &amp; Inclusao</p>
        ...
        <div className="t-section-inner">
          <div className="t-act-card">
            <div className="t-act-header">
              <p className="t-label">Educacao Digital</p>
              <h2 className="t-h2">Aulas de Informatica</h2>
              <p className="t-body">{p.info?.text}</p>
            </div>
            <div className="t-act-photos-2">
              {p.info?.image && (
                <div className="t-act-photo">
                  <Image src={p.info.image} alt="Aulas de informatica" width={700} height={480} className="w-full h-full object-cover" />
                </div>
              )}
              <div className="t-act-photo">
                <Image src={informaticaImg} alt="Material de informatica" width={700} height={480} className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="t-section t-section-blue">
        <div className="t-section-inner">
          <div className="t-act-card" style={{ background: "rgba(255,255,255,0.08)", borderColor: "rgba(255,255,255,0.15)" }}>
            <div className="t-act-header">
              <p className="t-label t-label-white">Cidadania &amp; Seguranca</p>
      ...
      <section className="t-section">
        <div className="t-section-inner">
          <div className="t-act-card">
            <div className="t-act-header">
              <p className="t-label">Saude &amp; Bem-estar</p>
              <h2 className="t-h2">Hidroginastica</h2>
              <p className="t-body">{p.hidro?.text}</p>
            </div>
            {p.hidro?.image && (
              <div className="t-act-photo-wide">
                <Image src={p.hidro.image} alt="Hidroginastica" width={1200} height={600} className="w-full h-full object-cover" />
              </div>
            )}
          </div>
        </div>
        ...
        <div className="t-section-inner">
          <div className="t-act-card">
            <div className="t-act-header">
              ...
              <h2 className="t-h2">Karate</h2>
              <p className="t-body">{p.karate?.text}</p>
            </div>
            <div className="t-act-photos-2">
              {p.karate?.image && (
                <div className="t-act-photo">
                  <Image src={p.karate.image} alt="Karate" width={700} height={480} className="w-full h-full object-cover" />
                </div>
              )}
              <div className="t-act-photo">
                <iframe
                  ...
                  title="Reel Karate Associacao Amigo do Povo"
                  scrolling="no"
                  allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"
                  allowFullScreen
                />
      ...
      <section className="t-section">
        <div className="t-section-inner">
          <div className="t-act-card">
            <div className="t-act-header">
              <p className="t-label">Esporte Aquatico</p>
              <h2 className="t-h2">Natacao</h2>
              <p className="t-body">{p.natacao?.text}</p>
            </div>
            {p.natacao?.image && (
              <div className="t-act-photo-wide">
                <Image src={p.natacao.image} alt="Natacao" width={1200} height={600} className="w-full h-full object-cover" />
              </div>
            )}
          </div>
        </div>
      ...
      <section className="t-section t-section-blue">
        <div className="t-section-inner">
          <div className="t-cards-grid">
            <div className="t-act-card" style={{ background: "rgba(255,255,255,0.08)", borderColor: "rgba(255,255,255,0.15)" }}>
              <p className="t-label t-label-white">Saude Mental</p>
              <h2 className="t-h2" style={{ color: "#fff" }}>Atendimento Psicanalitico</h2>
              <p className="t-body" style={{ color: "rgba(255,255,255,0.8)" }}>{p.psi?.text}</p>
              {p.psi?.image && (
                <div className="t-act-photo" style={{ marginTop: "1rem" }}>
                  <Image src={p.psi.image} alt="Psicanalise" width={700} height={480} className="w-full h-full object-cover" />
                </div>
              )}
            </div>
            <div className="t-act-card" style={{ background: "rgba(255,255,255,0.08)", borderColor: "rgba(255,255,255,0.15)", padding: "1.2rem", justifyContent: "center" }}>
              <Image
                src={psyPoster}
                alt="Cartaz atendimento em psicanalise"
                width={700}
                height={900}
      ...
      <section className="t-section">
        <div className="t-section-inner">
          <div className="t-cards-grid">
            <div className="t-act-card">
              <p className="t-label">Reabilitacao</p>
              ...
              <div className="t-act-reel-clip" style={{ marginTop: "1rem" }}>
                <iframe
                  ...
                  className="t-social-embed-frame"
                  title="Reel Fisioterapia Associacao Amigo do Povo"
                  scrolling="no"
                  allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"
                  allowFullScreen
                />
            ...
            <div className="t-act-card">
              ...
              <div className="t-act-reel-clip" style={{ marginTop: "1rem" }}>
                <iframe
                  ...
                  allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"
                  allowFullScreen
                  title="Reel Funcional Associacao Amigo do Povo"
                  scrolling="no"
                />
              </div>
            </div>
      ...
      <section className="t-section t-section-lightblue">
        <div className="t-section-inner">
          <div className="t-act-card">
            <div className="t-act-header">
              <p className="t-label">Estrategia &amp; Raciocinio</p>
      ...
      <section className="t-section">
        <div className="t-section-inner">
          <div className="t-cards-grid">
            <div className="t-act-card">
              <p className="t-label">Arte &amp; Expressao</p>
              <h2 className="t-h2">Danca</h2>
              <div className="t-act-reel-clip" style={{ marginTop: "1rem" }}>
                <iframe
                  src={REEL_DANCA_URL}
                  className="t-act-reel-frame"
                  allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"
                  allowFullScreen
                  title="Reel Danca Associacao Amigo do Povo"
                  scrolling="no"
                />
              </div>
            </div>
            <div className="t-act-card">
              <p className="t-label">Saude Visual</p>
              ...
              <div className="t-act-photo" style={{ marginTop: "1rem" }}>
                <Image src={otalmoImg} alt="Atendimento oftalmologico" width={700} height={480} className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="galeria" className="t-section t-section-blue">
        <div className="t-section-inner">
          <div className="t-section-head">
            ...
            <h2 className="t-h2" style={{ color: "#fff" }}>Galeria do portfolio</h2>
          </div>
      ...
      <section id="contato" className="t-section t-section-cta">
        <div className="t-section-inner">
          <div className="t-cta-grid">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              <div className="t-cta-stat"><strong>Endereco</strong><span>Av. Sao Bernardo 2, Qd 89 Lt 15 - Setor Sao Bernardo</span></div>
      ...
      <footer className="t-footer">
        <div className="t-footer-inner">
          <Image src={logoAssociacao} alt="Logo Associacao Amigo do Povo" width={80} height={80} className="t-footer-logo" />
          <p className="t-footer-name">Associacao Amigo do Povo</p>
          <p className="t-footer-copy">CNPJ 62.768.212/0001-70 · Av. Sao Bernardo 2, Qd 89 Lt 15, Setor Sao Bernardo</p>
